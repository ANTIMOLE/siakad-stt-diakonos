  ...
  if (!krs || !krs.detail || krs.detail.length === 0) {
    return (
      <div className="space-y-6">
        <PageHeader
          title="Jadwal Kuliah"
          description="Jadwal kuliah Anda untuk semester ini"
        />
        <Card>
            ...
            <Card key={group.hari}>
              <CardHeader>
                <div className="flex items-center gap-2">
                  ...
                  <Badge
                    variant={group.hari === currentDay ? 'default' : 'secondary'}
                    className="ml-2"
                  >
                    {group.jadwal.length} kelas
                  </Badge>
                  {group.hari === currentDay && (
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  ...
                  <div className="text-center p-4 rounded-lg bg-green-50">
                    ...
                    <p className="text-2xl font-bold text-green-600">
                      {(totalKelas / uniqueDays).toFixed(1)} kelas
                    </p>
                  </div>
                </div>
              </div>
